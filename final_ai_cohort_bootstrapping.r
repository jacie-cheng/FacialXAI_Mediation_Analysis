...
file_name <- "output/ai_cohort.txt"
sink(file_name)
## FITTING THE MODELS ##
# lavaan
mod <- 
...
correct_path_names[["Correct.Follows_AI~Q2"]][[4]] <- c("Q5~Q2.g1", "Q4~Q5.g1", "Follows_AI~Q4.g1")
...
incorrect_path_names[["Incorrect.Follows_AI~Q2"]][[4]] <- c("Q5~Q2.g2", "Q4~Q5.g2", "Follows_AI~Q4.g2")
