...
file_name <- "output/xai_cohort.txt"
sink(file_name)
...
correct_path_names[["Correct.Follows_AI~Q2"]][[3]] <- c("Q5~Q2.g1", "Follows_AI~Q5.g1")
correct_path_names[["Correct.Follows_AI~Q2"]][[4]] <- c("Q6~Q2.g1", "Follows_AI~Q6.g1")
correct_path_names[["Correct.Follows_AI~Q2"]][[5]] <- c("Q7~Q2.g1", "Follows_AI~Q7.g1")
correct_path_names[["Correct.Follows_AI~Q2"]][[6]] <- c("Q5~Q2.g1", "Q4~Q5.g1", "Follows_AI~Q4.g1")
correct_path_names[["Correct.Follows_AI~Q2"]][[7]] <- c("Q6~Q2.g1", "Q4~Q6.g1", "Follows_AI~Q4.g1")
correct_path_names[["Correct.Follows_AI~Q2"]][[8]] <- c("Q7~Q2.g1", "Q4~Q7.g1", "Follows_AI~Q4.g1")
...
incorrect_path_names[["Incorrect.Follows_AI~Q2"]][[3]] <- c("Q5~Q2.g2", "Follows_AI~Q5.g2")
incorrect_path_names[["Incorrect.Follows_AI~Q2"]][[4]] <- c("Q6~Q2.g2", "Follows_AI~Q6.g2")
incorrect_path_names[["Incorrect.Follows_AI~Q2"]][[5]] <- c("Q7~Q2.g2", "Follows_AI~Q7.g2")
incorrect_path_names[["Incorrect.Follows_AI~Q2"]][[6]] <- c("Q5~Q2.g2", "Q4~Q5.g2", "Follows_AI~Q4.g2")
incorrect_path_names[["Incorrect.Follows_AI~Q2"]][[7]] <- c("Q6~Q2.g2", "Q4~Q6.g2", "Follows_AI~Q4.g2")
incorrect_path_names[["Incorrect.Follows_AI~Q2"]][[8]] <- c("Q7~Q2.g2", "Q4~Q7.g2", "Follows_AI~Q4.g2")
