...
file_name <- "output/AI_CORRECT_xai_presence_cohort.txt"
sink(file_name)
...
## 
correct_path_names[["Easy.Follows_AI~XAI_Presence"]][[1]] <- c("Follows_AI~XAI_Presence.g1")
correct_path_names[["Easy.Follows_AI~XAI_Presence"]][[2]] <- c("Q4~XAI_Presence.g1", "Follows_AI~Q4.g1")

incorrect_path_names[["Hard.Follows_AI~XAI_Presence"]][[1]] <- c("Follows_AI~XAI_Presence.g2")
incorrect_path_names[["Hard.Follows_AI~XAI_Presence"]][[2]] <- c("Q4~XAI_Presence.g2", "Follows_AI~Q4.g2")
