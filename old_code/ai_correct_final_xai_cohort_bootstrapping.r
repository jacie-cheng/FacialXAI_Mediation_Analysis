...
input_data <- read.csv('raw_xai_allqs.csv')
...
file_name <- "output/AI_CORRECT_xai_cohort.txt"
sink(file_name)
...
# glm
mod2 <- "Follows_AI ~ Q2 + Q4 + Q5 + Q6 + Q7"
...
# correct_path_names[["Easy.Follows_AI~Q2"]][[1]] <- c("Follows_AI~Q2.g1")
# correct_path_names[["Easy.Follows_AI~Q2"]][[2]] <- c("Q4~Q2.g1", "Follows_AI~Q4.g1")
# correct_path_names[["Easy.Follows_AI~Q2"]][[3]] <- c("Q5~Q2.g1", "Follows_AI~Q5.g1")
# correct_path_names[["Easy.Follows_AI~Q2"]][[4]] <- c("Q6~Q2.g1", "Follows_AI~Q6.g1")
# correct_path_names[["Easy.Follows_AI~Q2"]][[5]] <- c("Q7~Q2.g1", "Follows_AI~Q7.g1")
# correct_path_names[["Easy.Follows_AI~Q2"]][[6]] <- c("Q5~Q2.g1", "Q4~Q5.g1", "Follows_AI~Q4.g1")
# correct_path_names[["Easy.Follows_AI~Q2"]][[7]] <- c("Q6~Q2.g1", "Q4~Q6.g1", "Follows_AI~Q4.g1")
# correct_path_names[["Easy.Follows_AI~Q2"]][[8]] <- c("Q7~Q2.g1", "Q4~Q7.g1", "Follows_AI~Q4.g1")
...
incorrect_path_names[["Hard.Follows_AI~Q2"]][[4]] <- c("Q6~Q2.g2", "Follows_AI~Q6.g2")
incorrect_path_names[["Hard.Follows_AI~Q2"]][[5]] <- c("Q7~Q2.g2", "Follows_AI~Q7.g2")
incorrect_path_names[["Hard.Follows_AI~Q2"]][[6]] <- c("Q5~Q2.g2", "Q4~Q5.g2", "Follows_AI~Q4.g2")
incorrect_path_names[["Hard.Follows_AI~Q2"]][[7]] <- c("Q6~Q2.g2", "Q4~Q6.g2", "Follows_AI~Q4.g2")
incorrect_path_names[["Hard.Follows_AI~Q2"]][[8]] <- c("Q7~Q2.g2", "Q4~Q7.g2", "Follows_AI~Q4.g2")
